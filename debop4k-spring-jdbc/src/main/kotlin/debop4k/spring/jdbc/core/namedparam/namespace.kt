...
operator fun MapSqlParameterSource.set(paramName: String, value: Any?, sqlType: Int)
    = this.addValue(paramName, value, sqlType)

operator fun MapSqlParameterSource.set(paramName: String, value: Any, sqlType: Int, typeName: String)
