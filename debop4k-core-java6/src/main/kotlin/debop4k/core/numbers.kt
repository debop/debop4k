...
@JvmOverloads fun Int.min(other: Int = Int.MAX_VALUE): Int = Math.min(this, other)
@JvmOverloads fun Int.max(other: Int = Int.MIN_VALUE): Int = Math.max(this, other)
...
@JvmOverloads fun Long.min(other: Long = Long.MAX_VALUE): Long = Math.min(this, other)
@JvmOverloads fun Long.max(other: Long = Long.MIN_VALUE): Long = Math.max(this, other)
...
@JvmOverloads fun Byte.min(other: Byte = Byte.MAX_VALUE): Byte = if (this < other) this else other
@JvmOverloads fun Byte.max(other: Byte = Byte.MIN_VALUE): Byte = if (this > other) this else other
...
@JvmOverloads fun Short.min(other: Short = Short.MAX_VALUE): Short = if (this < other) this else other
@JvmOverloads fun Short.max(other: Short = Short.MIN_VALUE): Short = if (this > other) this else other
...
@JvmOverloads fun Float.min(other: Float = Float.MAX_VALUE): Float = Math.min(this, other)
@JvmOverloads fun Float.max(other: Float = Float.MIN_VALUE): Float = Math.max(this, other)
fun Float.coerce(min: Float, max: Float): Float = this.min(min).max(max)

@JvmOverloads fun Double.min(other: Double = Double.MAX_VALUE): Double = Math.min(this, other)
@JvmOverloads fun Double.max(other: Double = Double.MIN_VALUE): Double = Math.max(this, other)
