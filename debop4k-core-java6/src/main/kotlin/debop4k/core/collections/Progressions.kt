...
@JvmOverloads
fun partitioningFromRange(start: Int, endInclusive: Int, step: Int = 1, partitionCount: Int = 1): List<IntProgression> {
...
@JvmOverloads
fun groupedLongFromRange(start: Long, endInclusive: Long, step: Long = 1, groupSize: Long = 1L): List<LongProgression> {
  return LongProgression
      .fromClosedRange(start, endInclusive, step)
      .grouped(groupSize)
}
...
@JvmOverloads
fun partitioningFromRange(start: Long, endInclusive: Long, step: Long = 1, partitionCount: Long = 1): List<LongProgression> {
