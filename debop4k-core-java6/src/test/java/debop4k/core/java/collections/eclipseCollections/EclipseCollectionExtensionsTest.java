...
public class EclipseCollectionExtensionsTest {
  ...
  public void testArrayListOf() {
    IntArrayList intArrayList = PrimitiveArraysKt.intArrayListOf(1, 2, 3, 4, 5);
    ...
    LongArrayList longArrayList = PrimitiveArraysKt.longArrayListOf(1, 2, 3, 4, 5);
    ...
    FloatArrayList floatArrayList = PrimitiveArraysKt.floatArrayListOf(1, 2, 3, 4, 5);
    ...
    DoubleArrayList doubleArrayList = PrimitiveArraysKt.doubleArrayListOf(1, 2, 3, 4, 5);
  ...
  public void testAsList() {
    List<Integer> ints = PrimitiveArraysKt.asList(PrimitiveArraysKt.intArrayListOf(1, 2, 3, 4, 5));
    assertThat(ints).hasSize(5).contains(1, 2, 3, 4, 5);

    List<Long> longs = PrimitiveArraysKt.asList(PrimitiveArraysKt.longArrayListOf(1, 2, 3, 4, 5));
    assertThat(longs).hasSize(5).contains(1L, 2L, 3L, 4L, 5L);
  }

  @Test
  public void testFastListOf() {
    FastList<Object> empty = PrimitiveArraysKt.fastListOf();
    assertThat(empty).isEmpty();

    FastList<Integer> ints = PrimitiveArraysKt.fastListOf(1, 2, 3, 4, 5);
    assertThat(ints).isNotEmpty().contains(1, 2, 3, 4, 5);
  }

  @Test
  public void testUnifiedSetOf() {
    UnifiedSet<Integer> set = PrimitiveArraysKt.unifiedSetOf(1, 2, 3, 3, 3);
  ...
  public void testUnifiedMapOf() {
    UnifiedMap<Integer, String> map = PrimitiveArraysKt.unifiedMapOf(new Pair(1, "a"), new Pair(2, "b"), new Pair(3, "c"));
