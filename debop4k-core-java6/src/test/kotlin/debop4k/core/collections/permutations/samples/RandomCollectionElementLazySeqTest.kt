...
import debop4k.core.collections.permutations.continually
import org.junit.Test
import java.util.*

class RandomCollectionElementLazySeqTest : AbstractPermutationTest() {

  val random = Random(System.currentTimeMillis())

  @Test
  fun testRandomCollection() {
    val charStream = continually { randomChar() }
