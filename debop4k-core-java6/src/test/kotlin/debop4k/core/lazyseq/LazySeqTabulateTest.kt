...
import debop4k.core.lazyseq.samples.piSeriesEstimation
 ...
 */
class LazySeqTabulateTest : AbstractLazySeqTest() {

  @Test
  fun testGrowingStrings() {
    val strings = LazySeq.tabulate(0) { StringUtils.repeat("*", it) }
    assertThat(strings.take(6)).isEqualTo(lazySeqOf("", "*", "**", "***", "****", "*****"))
