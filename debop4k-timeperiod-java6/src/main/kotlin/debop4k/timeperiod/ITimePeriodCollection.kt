...
interface ITimePeriodCollection : ITimePeriodContainer {
   ...
   */
  fun insidePeriods(target: ITimePeriod): MutableList<ITimePeriod>

  fun overlapPeriods(target: ITimePeriod): MutableList<ITimePeriod>
   ...
   */
  fun relationPeriods(target: ITimePeriod, vararg relations: PeriodRelation): MutableList<ITimePeriod>
