...
//      if (limitBox != null) {
//        if (!limitBox.isInRange(x1, y1)) {
//          log.warn("bbox의 값이 제한 범위를 벗어났습니다. limitBox={}, x={}, y={}", limitBox, x1, y1);
//        }
//        if (!limitBox.isInRange(x2, y2)) {
//          log.warn("bbox의 값이 제한 범위를 벗어났습니다. limitBox={}, x={}, y={}", limitBox, x2, y2);
//        }
//      }
...
//      rad += PI_M2;
  ...
  public static Vector getVector(@NonNull Point2D.Double s, @NonNull Point2D.Double e) {
    ...
    return Geometryx.vectorOf(degree, distance);
  }
  ...
  public static Point2D.Double getVectorEndPoint(Point2D.Double base, double degree, double length) {
    ...
    double x = length * sin(rad) + base.x;
    double y = length * cos(rad) + base.y;
