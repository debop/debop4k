...
fun <E> toLazySeq(): Collector<E, LazySeq<E>, LazySeq<E>> = DummyLazySeqCollector()

/**
 * DummyLazySeqCollector
 * @author sunghyouk.bae@gmail.com
 */
class DummyLazySeqCollector<T> : Collector<T, LazySeq<T>, LazySeq<T>> {
  ...
  override fun accumulator(): BiConsumer<LazySeq<T>, T> {
  ...
  override fun supplier(): Supplier<LazySeq<T>> {
    throw IllegalStateException("Should never be called")
  }

  override fun combiner(): BinaryOperator<LazySeq<T>> {
    throw IllegalStateException("Should never be called")
  }

  override fun finisher(): Function<LazySeq<T>, LazySeq<T>> {
    throw IllegalStateException("Should never be called")
  }
}