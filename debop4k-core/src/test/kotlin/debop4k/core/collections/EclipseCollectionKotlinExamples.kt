...
import debop4k.core.collections.PetType.*
...
//    assertThat(even.detect { it % 2 == 1 }).isEqualTo(0)
  ...
  @Test fun `get ages of pets`() {
    ...
    assertThat(sortedAges.median()).isEqualTo(2.0, offset)
  }
  ...
  @Test fun `group by pet type`() {
    ...
    assertThat(counts.occurrencesOf(CAT)).isEqualTo(2)
    assertThat(counts.occurrencesOf(DOG)).isEqualTo(2)
    assertThat(counts.occurrencesOf(HAMSTER)).isEqualTo(2)
    assertThat(counts.occurrencesOf(SNAKE)).isEqualTo(1)
    assertThat(counts.occurrencesOf(TURTLE)).isEqualTo(1)
    assertThat(counts.occurrencesOf(BIRD)).isEqualTo(1)
