...
class DurationBuilder(val period: Period) {
  ...
  operator fun times(multiplicand: Int): Duration = standardDuration.multipliedBy(multiplicand.toLong())
  operator fun times(multiplicand: Long): Duration = standardDuration.multipliedBy(multiplicand)

  operator fun div(divisor: Int): Duration = standardDuration.dividedBy(divisor.toLong())
  operator fun div(divisor: Long): Duration = standardDuration.dividedBy(divisor)
