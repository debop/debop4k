...
fun asBoolean(v: Boolean?): Boolean {
  return v ?: false
}
 ...
 * @param v 변환할 값
 * *
 * @return 변환된 값, null 이면 0을 반환한다.
 */
fun asByte(v: Byte?): Byte {
  return v ?: 0
}
