...
object Resourcex {
  ...
  fun getClassPathResourceStream(path: String,
                                 classLoader: ClassLoader = Resourcex::class.java.classLoader): InputStream? {
  ...
  fun getString(path: String,
                ...
                classLoader: ClassLoader = Resourcex::class.java.classLoader): String {
  ...
  fun getBytes(path: String,
               classLoader: ClassLoader = Resourcex::class.java.classLoader): ByteArray {
    return getClassPathResourceStream(path, classLoader)?.use { input ->
      input.toByteArray()
    } ?: emptyByteArray
  }
