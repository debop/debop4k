...
import debop4k.data.orm.hibernate.config.AbstractHibernateH2Configuration;
import debop4k.data.orm.hibernate.config.HibernateDataConfig;
...
public class HibernateH2Configuration extends AbstractHibernateH2Configuration {

  @Inject HibernateDataConfig hibernateDataConfig;

  @Override
  protected DatabaseSetting getDatabaseSetting() {
    return hibernateDataConfig.getDatabase().getDatabaseSetting();
  }
