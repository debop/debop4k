...
/**
 * PostgreSQL 용 Hibernate Configuration
 *
 * @author sunghyouk.bae@gmail.com
 */
public abstract class AbstractHibernatePostgreSqlConfiguration extends AbstractHibernateConfiguration {
  ...
  protected DatabaseSetting getDatabaseSetting() {
    return DatabaseSetting.builder()
                          ...
                          .jdbcUrl("jdbc:postgresql://127.0.0.1/" + getDatabaseName())
                          .username("root")
                          .password("root")
                          .build();
  }
