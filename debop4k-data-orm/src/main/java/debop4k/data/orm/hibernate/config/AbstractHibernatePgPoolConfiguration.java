...
/**
 * PgPool II 를 사용하여 PostgreSQL 을 사용하는 Hibernate Configuration
 *
 * @author sunghyouk.bae@gmail.com
 * @since 2015. 8. 26.
 */
public abstract class AbstractHibernatePgPoolConfiguration extends AbstractHibernatePostgreSqlConfiguration {
  ...
  protected DatabaseSetting getDatabaseSetting() {
    return
        DatabaseSetting.builder()
                       ...
                       .jdbcUrl("jdbc:postgresql://localhost:9999/" + getDatabaseName() + "?Set=UTF8")
                       .username("root")
                       .password("root")
                       .build();
