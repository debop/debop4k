 ...
 * @since 2015. 8. 26.
 */
public abstract class CompressedStringUserType extends CompressedUserType {

  public byte[] compress(String str) {
    if (isEmpty(str))
      return null;
    return compressor().compress(toUtf8Bytes(str));
  }

  public String decompress(byte[] compressedByte) {
    if (Arrayx.isNullOrEmpty(compressedByte))
      return null;
    return toUtf8String(compressor().decompress(compressedByte));
  }
